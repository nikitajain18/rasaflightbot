...
- tell me the [flight timings](flight_time) from [detroit](fromloc.city_name) to [new york](toloc.city_name)
- show me the [flight timings](flight_time) for flights from [detroit](fromloc.city_name) to [new york](toloc.city_name)
- can i see the times for flights from [bombay](fromloc.city_name) to [pune](toloc.city_name)
